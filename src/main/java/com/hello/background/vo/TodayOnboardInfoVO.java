...
@NoArgsConstructor
@AllArgsConstructor
public class TodayOnboardInfoVO implements Serializable {
    /**
     * 用户ID
     */
    private Integer id;
    ...
    public TodayOnboardInfoVO(SuccessfulPerm s) {
        this.setClientId(s.getClientId());
        this.setClientName(s.getClientName());
        this.setCaseId(s.getCaseId());
