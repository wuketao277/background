...
public class KPIWorkDaysAdjustController {
    ...
    public Page<KPIWorkDaysAdjustVO> queryPage(@RequestBody KPIWorkDaysAdjustRequest request) {
        return service.queryPage(request.getSearch(), request.getCurrentPage(), request.getPageSize());
    }
